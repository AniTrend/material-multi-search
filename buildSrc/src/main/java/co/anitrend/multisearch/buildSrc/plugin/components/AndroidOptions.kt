...
import co.anitrend.multisearch.buildSrc.plugin.extensions.androidExtensionsExtension
import co.anitrend.multisearch.buildSrc.plugin.extensions.publishingExtension
...
private fun Project.configureMavenPublish(javadocJar: Jar, sourcesJar: Jar) {
    ...
    publishingExtension().publications {
        ...
        create("maven", MavenPublication::class.java) {
            groupId = "co.anitrend.multisearch"
            ...
            pom {
                name.set("Material Multi Search")
                description.set("A reworked code base fork of https://github.com/iammert/MultiSearchView with additional customization:")
                url.set("https://github.com/anitrend/material-multi-search")
                licenses {
                    license {
    ...
    val dokka = tasks.withType(DokkaTask::class.java) {
        ...
        configuration {
            ...
            sourceLink {
                ...
                url =
                    "https://github.com/anitrend/material-multi-search/tree/develop/${project.name}/src/main/kotlin"
                lineSuffix = "#L"
            }
